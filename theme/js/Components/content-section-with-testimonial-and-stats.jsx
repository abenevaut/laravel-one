export default function ContentSectionWithTestimonialAndStats({ contentCategory, contentTitle, contentBody, caption, captionImage, stats, outlink, outlinkTitle, captionAuthor = '', captionAuthorTitle = '' }) {
  return (
                  ...
                  captionAuthor
                    ? (
                      <figcaption className="mt-6 text-sm leading-6 text-gray-300">
                        <strong className="font-semibold text-white">{captionAuthor}</strong> {
                        captionAuthorTitle
                          ? (
                            `, ${captionAuthorTitle}`
                          )
